...
public class ThrusterScript : MonoBehaviour {
	...
	void FixedUpdate() {
		if (Input.GetKey (keyCode)) {
			...
			if(transform.parent != null && transform.parent.gameObject.rigidbody2D != null) {
				transform.parent.gameObject.rigidbody2D.AddForceAtPosition(transform.right * 0.2f, transform.position);
			}
		}
	}
